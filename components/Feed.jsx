                ...
                posts.map((elm,key)=>{return(
                    <div key={key} className='flex flex-col gap-2 px-10 mt-5'>
                        <div className='flex items-center'>
                            <img className='h-[35px] ml-5 mr-1' src={`https://${backend+elm.owners.image}`} onClick={()=>{showOtherProfile(elm.owner)}} />
                            ...
                            <div className={`${elm.owner != elm.origin ? 'flex items-center':'hidden' } `}>
                                ...
                                <img className='h-[35px] ml-1  mr-1' src={`https://${backend+elm.origins.image}`} onClick={()=>{showOtherProfile(elm.origin)}} />
